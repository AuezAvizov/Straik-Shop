...
<html>
<head>
    <title>Редактировать комплект</title>
...
<body>
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Панель управления / Редактировать комплект
                </li>
            </ol>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa fa-money fa-fw"></i> Редактировать комплект
                    </h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <p style="font-size:15px; font-weight:bold;">
                                    Пример URL комплекта: navy-blue-t-shirt
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="submit" name="update" value="Обновить комплект" class="btn btn-primary form-control">
                            </div>
                        </div>
...
if (isset($_POST['update'])) {
    ...
    if ($run_product) {
        echo "<script>alert('Комплект был успешно обновлен')</script>";
