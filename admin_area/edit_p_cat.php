...
?>
    ...
    // Проверяем, установлен ли параметр 'edit_p_cat' в URL
    if (isset($_GET['edit_p_cat'])) {

        // Получаем идентификатор категории продукта из параметра URL
        $edit_p_cat_id = $_GET['edit_p_cat'];

        // Запрашиваем данные категории продукта из базы данных
        $edit_p_cat_query = "SELECT * FROM product_categories WHERE p_cat_id='$edit_p_cat_id'";
        $run_edit = mysqli_query($con, $edit_p_cat_query);
        $row_edit = mysqli_fetch_array($run_edit);

        // Извлекаем данные категории продукта
    ...
    if (isset($_POST['update'])) {
        ...
        // Обновляем данные категории продукта в базе данных
