...
<div class="row"><!-- 1 row Starts -->
    <div class="col-lg-12"><!-- col-lg-12 Starts -->
        <ol class="breadcrumb"><!-- breadcrumb Starts -->
            <li class="active">
                <i class="fa fa-dashboard"></i> Панель управления / Редактировать условия
            </li>
        </ol><!-- breadcrumb Ends -->
    </div><!-- col-lg-12 Ends -->
</div><!-- 1 row Ends -->
        ...
        <div class="panel panel-default"><!-- panel panel-default Starts -->
            <div class="panel-heading"><!-- panel-heading Starts -->
                <h3 class="panel-title"><!-- panel-title Starts -->
                    <i class="fa fa-money fa-fw"></i> Редактировать условия
                </h3><!-- panel-title Ends -->
            ...
            <div class="panel-body"><!-- panel-body Starts -->
                <form class="form-horizontal" action="" method="post"><!-- form-horizontal Starts -->
                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label"> Название условия </label>
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Starts -->
                            <textarea name="term_desc" class="form-control" rows="6" cols="19"><?php echo $term_desc; ?></textarea>
                        </div><!-- col-md-6 Ends -->
                    </div><!-- form-group Ends -->

                    <div class="form-group"><!-- form-group Starts -->
                        <label class="col-md-3 control-label"> Ссылка на условие </label>
                        <div class="col-md-6"><!-- col-md-6 Starts -->
                    ...
                    <div class="form-group"><!-- form-group Starts -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Starts -->
                            <input type="submit" name="update" value="Обновить условие" class="btn btn-primary form-control">
                        </div><!-- col-md-6 Ends -->
                    </div><!-- form-group Ends -->
...
<?php
    if (isset($_POST['update'])) {
        ...
        if ($run_term) {
            echo "<script>alert('Условие успешно обновлено')</script>";
