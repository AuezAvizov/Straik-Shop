	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Kazahstan.<br>
				Beibitshilik street 24.
			</address>
				<div class="phone">
					Телфон:
					<a class="phone__number" href="tel:0123456789">7-700-392-29-23</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">auez.avizov@mail.ru</a>
				</div>
			</div>
