...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-dashboard"></i> Панель управления / Редактировать профиль
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-money fa-fw"></i> Редактировать профиль
                </h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Работа: </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Контакт: </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="submit" name="update" value="Обновить пользователя" class="btn btn-primary form-control">
                        </div>
                    </div>
                </form>
            </div>
...
if(isset($_POST['update'])){
    ...
    if($run_admin){
        echo "<script>alert('Пользователь успешно обновлен. Войдите снова.')</script>";
        echo "<script>window.open('login.php','_self')</script>";
        session_destroy();
    }
