...
include("../functions.php");         // Подключаем файл с функциями, содержащий items()
?>
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
           <a class="logo__link" href="/military-shop/index.php">
            <img class="logo__img" src="images/" alt="Airsoft Store Logo" width="237" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          <ul class="categories">
            <li class="categories__item">
              <a class="categories__link" href="shop.php?category=weapons">
                Weapons
              </a>
            </li>
            <li class="categories__item">
              <a class="categories__link" href="shop.php?category=gear">
                Gear
              </a>
            </li>
            <li class="categories__item">
              <a class="categories__link" href="shop.php?category=accessories">
                Accessories
              </a>
            </li>
            <li class="categories__item">
                ...
                <div class="clearfix">
                  ...
                  <div class="dropdown__half">
                    ...
                    <ul class="dropdown__items">
                      ...
                      <li class="dropdown__item">
                        <a href="change_password.php" class="dropdown__link">Change Password</a>
                      </li>
                      <li class="dropdown__item">
