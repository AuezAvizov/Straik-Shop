<div class="panel panel-default sidebar-menu"><!-- панель panel-default sidebar-menu Начало -->

    <div class="panel-heading"><!-- заголовок панели Начало -->
    ...
    </div><!-- заголовок панели Конец -->

    <div class="panel-body"><!-- тело панели Начало -->

        <ul class="nav nav-pills nav-stacked"><!-- навигация nav-pills nav-stacked Начало -->
        ...
        </ul><!-- навигация nav-pills nav-stacked Конец -->

    </div><!-- тело панели Конец -->

</div><!-- панель panel-default sidebar-menu Конец -->
